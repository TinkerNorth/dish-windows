...
<!DOCTYPE TS>
<!--
    French (fr) translation catalog for the Dish Windows client.

    Sources of truth:
      * `tr("...")` call sites in src/UI/ and src/FeatureSettings.cpp.
      * Verbatim reuse of dish-android values-fr/strings.xml for any key that
        maps cleanly to an Android string id.
      * `type="unfinished"` for strings with no Android counterpart — Qt falls
        back to the English source automatically.
-->
