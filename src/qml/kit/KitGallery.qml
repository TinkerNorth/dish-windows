...
Item {
    ...
    readonly property var demoCapRows: [
        ...
        { "feature": "motion", "inOk": true, "linkOk": false, "typeOk": true, "hostOk": false,
          "verdict": "unavailable", "failingLayer": "link", "hasFailingLayer": true,
          "name": qsTr("Gyro"),
          "why": qsTr("Standard mode can’t carry it — switch the connection to Direct.") },
        { "feature": "rumble", "inOk": true, "linkOk": true, "typeOk": true, "hostOk": true,
          "verdict": "off", "failingLayer": "input", "hasFailingLayer": false,
          "name": qsTr("Rumble"), "why": qsTr("Turned off for this binding.") },
